...
export default function Index({ auth, kelas, search }) {
    const header = (
        <div className="row g-2 align-items-center">
            <div className="col">
                {/* Page pre-title */}
                <div className="page-pretitle">Overview</div>
                <h2 className="page-title">Kelas</h2>
            </div>
            {/* Page title actions */}
    ...
    return (
        <AuthenticatedLayout user={auth.user} header={header}>
            ...
            <Pagination links={kelas.links} search={search ? search : ""} />
        </AuthenticatedLayout>
    );
}
